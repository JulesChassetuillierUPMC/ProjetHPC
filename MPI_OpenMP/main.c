...
#endif 
/* 
	2017-03-26 : version MPI + Open MP 
	Jules Chassetuiller
	Félix Ernest
	MAIN 4
	Polytech Paris UPMC
...
void evaluate(tree_t * T, result_t *result)
{
	...
	if (n_moves == 0) {
       ...
       // évalue récursivement les positions accessibles à partir d'ici  : teste sur la profondeur : si height = 0 -< #pragma openmp parallel for schedule(dynamic)
        if (T->height == 0)
        {
